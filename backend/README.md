...
## Project Structure
    ...
    ├── wedding_party_track_42951  # Django project configurations
...
1. Clone this repo and `cd wedding_party_track_42951`
...
2. Clone this repo and `cd wedding_party_track_42951`
